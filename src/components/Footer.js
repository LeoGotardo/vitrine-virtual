          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              {onNavigate && (
                <>
                  <li>
                    <button onClick={() => onNavigate('produtos')} className="text-gray-500 hover:text-white transition-colors">
                      Produtos
                    </button>
                  </li>
                  <li>
                    <button onClick={() => onNavigate('ofertas')} className="text-gray-500 hover:text-white transition-colors">
                      Ofertas
                    </button>
                  </li>
                  <li>
                    <button onClick={() => onNavigate('cadastro')} className="text-gray-500 hover:text-white transition-colors">
                      Cadastrar Produto
                    </button>
                  </li>
                </>
